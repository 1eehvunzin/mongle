...
export default function HomeScreen() {
  ...
  // home screen itself, rather than a standalone page before it. Deferred
  // a tick — navigating during this screen's own first-mount effect can
  // fire before the root Stack has finished mounting ("Attempted to
  // navigate before mounting the Root Layout component").
  useEffect(() => {
    if (onboardingState.nicknameSet) return;
    const id = setTimeout(() => router.push("/nickname"), 0);
            ...
            <Pressable onPress={() => router.push("/capture")}>
              ...
              >
                ...
                >
                  ...
                  >
                    오늘은 <Text className="font-bold">{meta.cloud}</Text>이 잘
                    보이는 날! 찍어서 채워볼까?
                  </Text>
