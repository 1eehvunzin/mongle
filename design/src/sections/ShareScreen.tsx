    ...
    <div style={{ position: "absolute", inset: 0, background: glass.bg }}>
      ...
      <div style={{ margin: "6px 16px 0" }}>
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(180deg, rgba(20,30,36,0.05), rgba(20,30,36,0.55))",
            }}
          />
          ...
          <div style={{ position: "absolute", top: 13, left: 13 }}>
            ...
            >
              <span style={{ fontSize: 9, fontWeight: 600, color: glass.ink }}>
                No.014
              </span>
            </Glass>
          </div>
          <div style={{ position: "absolute", top: 13, right: 13 }}>
            <Glass
              ...
              style={{ padding: "3px 7px" }}
            >
              <span style={{ fontSize: 9, fontWeight: 700, color: glass.ink }}>
                ★★☆ 희귀
              </span>
            </Glass>
          </div>
        ...
        <div style={{ display: "flex", gap: 9, marginTop: 14 }}>
          ...
          >
            ...
            >
              ...
              <span style={{ fontSize: 12, fontWeight: 600, color: glass.ink }}>
                저장
              </span>
            </div>
          </Glass>
          ...
          >
            ...
            >
              <Icon name="link" size={14} color={glass.ink} />
              <span style={{ fontSize: 12, fontWeight: 600, color: glass.ink }}>
                링크
              </span>
            </div>
        ...
        <Glass
          tone={glass.blue}
          radius={999}
          style={{ marginTop: 14, padding: "15px 0" }}
        >
          <div
            style={{
              display: "flex",
          ...
          >
            ...
            <span style={{ fontSize: 13, fontWeight: 700, color: glass.ink }}>
              스토리 공유하기
            </span>
          </div>
        </Glass>
